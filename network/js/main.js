// Edited version of a file that was generated and downloaded per Gephi 0.9, Plugin SigmaExporter: Oxford Internet Institute, "sigmaExporter", https://github.com/oxfordinternetinstitute/gephi-plugins/tree/sigmaexporter-plugin/modules/sigmaExporter
...
// The following function (until Line 65) is a modified version of the function jQuery.getJSON(GetQueryStringParams("config", "config.json"), function(data, textStatus, jqXHR).
// It was modified using ChatGPT 3.5 with instructions to change out the config.data file depending on which checkbox is checked.
$(document).ready(function () {
    ...
    function loadConfig(configdata) {
        ...
        jQuery.getJSON(GetQueryStringParams("config", configdata), function (data, textStatus, jqXHR) {
            ...
            // As soon as page is ready (and data ready) set it up
